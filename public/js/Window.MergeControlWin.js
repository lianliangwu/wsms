var MergeControlWin = function(){
	...
	container.setInfo = function(infoMap){
		...
		this.nodeSelect.setOptions(makeNodeOptions(infoMap));	
	};

	container.init = function (verA, verB, viewer) {
		versionA = 'Version' + verA;
		versionB = 'Version' + verB;
		var selectedNode;
